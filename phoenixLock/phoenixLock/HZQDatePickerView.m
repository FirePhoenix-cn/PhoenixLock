...
- (void)awakeFromNib
{
    ...
    [self.sureBtn setTitleColor:[UIColor colorFromHexString:@"FA9909"] forState:0];
    self.sureBtn.layer.borderColor = [[UIColor colorFromHexString:@"FA9909"] CGColor];
    self.sureBtn.layer.masksToBounds = YES;
    
    /** 取消按钮 */
    self.cannelBtn.layer.cornerRadius = 4;
    self.cannelBtn.layer.borderWidth = 1;
    self.cannelBtn.layer.borderColor = [[UIColor colorFromHexString:@"BAB9B9"] CGColor];
...
- (IBAction)sureBtnClick:(id)sender {
    ...
    //delegate
    [self.delegate getSelectDate:self.selectDate :[self.datePickerView date] type:self.type];
